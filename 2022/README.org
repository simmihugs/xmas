#+TITLE: Simons @@latex:\\@@ Weihnachtsgeschichte @@latex:\\@@ 2022
#+AUTHOR:
#+DATE:
#+LANGUAGE: de
# +OPTIONS: toc:nil \n:t
...
# ###############
# Schriftgröße, besser für Handys
...
# ###############
# Schriftart
#+LATEX_HEADER: \usepackage{venturis2}
...
# ###############
# Große Buchstaben am Anfang von Kapiteln

#+LATEX_HEADER: \usepackage{lettrine}
#+LATEX_HEADER: \usepackage{GoudyIn}
#+LATEX_HEADER: \renewcommand{\LettrineFontHook}{\GoudyInfamily{}}
#+LATEX_HEADER: \newcommand{\cb}[2]{\lettrine[lines=3]{#1}{#2}}

# ###############
# Kein Kapitel nummeriung bitte
...
* code :noexport: 
** extarticle class
   Latex does not have extarticle, which is necessary to change the
   font size.
...
** title page with image
   #+begin_src emacs-lisp :eval no-export
     ...
     (setq org-latex-title-command
	   (concat
	    ...
	    "\\hspace*{-0.73cm}"
	    "\\begin{center}"
	    "\\includegraphics[width=0.5\\columnwidth]{santa}"
	    "\\end{center}"
	    "\\end{figure}"
	    "\\end{titlepage}\n"))
   #+end_src
   ...
   : {\large %a \par}
   : \vspace{3cm}
   : \begin{figure}[h]\hspace*{-0.73cm}\begin{center}\includegraphics[width=0.5\columnwidth]{santa}\end{center}\end{figure}\end{titlepage}
** export to epub (test)
...
* DONE Vorwort
  ...
  /Weihnachtsgeschichte/. Selbige, werter Leser haltet Ihr nun in
  ...
  #+ATTR_LATEX: :height 18cm
  [[file:figures/simon2.png]]
* DONE Dem Stress entfliehen
  ...
  Wohnungstür aufdrücken. Uff. @@latex:\newline@@
  ...
  Emacs und orgmode und latex nehmen ... und die meistens schalten
  ...
  es wahrscheinlich ganz allein mein Fehler. @@latex:\newline@@
  ...
  [[file:figures/simon3.png]]

* DONE Erster Simon auf der ISS
  ...
  jetzt gehts zum Markus \dots. @@latex:\newline@@
  ...
  *München Weltraumflughafen, 0800*
  @@latex:\newline@@ 

  Seit ich die Welt vor einer Alieninvasion gerettet habe[fn:1], bin
  ...
  Ich nicke nur, na das kann ja was werden.@@latex:\newline@@
  
  *Süddeutsche Zeitung, eine Woche später* @@latex:\newline@@ 
  ...
  haben und mit den Worten /Wenn es wodka gewesen wäre/, hatte der
  ...
  darauf gleich - /Die Schwerelosigkeit sei schuld gewesen/. In des
  ...
  #+ATTR_LATEX: :height 18cm
  [[file:figures/simon4.png]]
  
** summary :noexport:  
   Als Zeichen fuer die Internationale Versöhnung zwischen Ost und West
   hat die Bayerische Staatsregierung die glohreiche idee einen Bayern
   zur ISS zu schicken, der als zeichen des friedens und der versöhnung
   einen Kasten Weißbier und Weißwürste dabei haben soll.
* DONE Tomatensuppe
  ...
  tolle. Es sind wohl /Künstler/, denke ich mir. Der Anführer dieser
  ...
  *Paris* @@latex:\newline@@ 
  ...
  die kaputt ist und through I go. @@latex:\newline@@ 
  ...
  #+ATTR_LATEX: :height 18cm  
  [[file:figures/eifel.png]]

** summary :noexport:
  
   Auf grund der Klimaproteste, bei denen Suppe auf berühmte gemälde
   geschüttet wurde, kommt der internationale geheimdienst Psscht! auf
   mich zu um die Mona Lisa zu klauen - damit diese nicht von Suppe
   beschmutzt werden kann. Jetzt muss ich nur noch um ein Alibi zu
   haben meinen Kumpel Sebi davon ueberzeugen, nach paris zu fahren,
   und das es seine Idee war - und natuerlich das ding klauen, aber das
   ist ja das leichteste.
* DONE In den Bergen
  ...
  Türklinge vom Appartment ab. @@latex:\newline@@
...
[fn:1] Nachzulesen in einer früheren Weihnachtsgeschichte. 

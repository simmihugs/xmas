...
\usepackage[T1]{fontenc}
\date{}
\title{Weihnachtsgeschichte 2019}
\hypersetup{
 pdfauthor={Simon Grätz},
 pdftitle={Weihnachtsgeschichte 2019},
 pdfkeywords={},
 pdfsubject={},
...
\maketitle
\noindent \textbf{Liebe Lesende}, es ist wieder soweit, das ist meine diesjährige
...
gebissen hat\footnote{Mama weniger Gewürze, brauchst gar nicht so schauen}.
...
zwinge ich meine Opfern, so auch dir, als \emph{Geschenk} auf. Der Clou
ist, das ich nur \uline{einmal}, ein Geschenk \uline{selbst mache} (also keine
Pfenning dafür ausgeben) und das dann auch noch an \uline{alle}, die
...
\begin{center}
\emph{Fröhliche Weihnachten und einen guten Rutsch ins neue Jahr}

\emph{dein Simon}
\end{center}
\newpage
\section{Extraterestische Mitbewohner}
\label{sec:org5ac589c}
\begin{center}
\includegraphics[width=0.2\textwidth]{figures/alien8.png}
\end{center}
\noindent Ich sitze auf der Couch und kucke eine Cartoon serie. Es gibt ja 
Leute die finden, \emph{Zeichentrick} ist was für Kinder. Auf dem
...
Und ich werde murmeln: "\ldots{}und am ende wird alles auf dem gleichen
Haufen gekippt und verbrannt\ldots{}" 
...
\begin{center}
\emph{Samstag Morgen, es klingelt und ein Alien steht vor mir.}
\end{center}
...
blicke meine \emph{Gast} unsicher an. Ich kratze mich an der
...
der sich \emph{Kochen mit Lanz} in der Glotze mit erschreckender
Begeisterung ansieht. Okay, \textbf{here we go\ldots{}}
...
Mein Handy macht ein erfreutes \emph{Ding} als der Scanvorgang
...
übernehmen muss\footnote{Diese Idee wurde später sogar von einem bekannten
Schriftsteller gestohlen und in einem Buch verwendet.}. Noch in der selben Nacht veröffentlichten wir
...
die \emph{Todeslaser Manufaktur Gmbh\&Co}, deren Geschäftsfeld daran bestand
mithilfe von radioaktiven Joghurt eine Zombieapokalypse zu verursachen
um dann unsere \emph{Waren} zu verkaufen und dadurch unfassbar reich zu
...
\noindent Inzwischen kommt im Fernsehen \emph{Bares für Rares}, jedes mal
...
\emph{Sohn}, also ein \emph{der} - das macht das Schreiben der Geschichte um
einiges einfacher. 
\begin{center}
"Verstehst du was ich sage?", frage ich als nächstes.
\end{center}
Zum ersten Mal bekomme ich eine unmissverständliche Antwort. Er kuckt
mich mit einem \emph{Ist das dein Ernst?}-Blick an. Die Gestik und Mimik
...
machen willst, aber das geht nicht. Ich habe leider kein \ldots{} zu viel
zu tun \ldots{} kannst du mir bitte die Nummer von deiner Mutter geben?"
\end{center}
...
\end{center}
\begin{center}
"Okay, ich nenn dich \emph{Zuschwer}", entscheide ich.
\end{center}
\begin{center}
...
\newpage
\section{Veganismus}
\label{sec:orge3c875d}
\begin{center}
\includegraphics[width=0.6\textwidth]{figures/vegan.jpg}
\end{center}
...
ich dich esse \ldots{} ich frage mich wie du wohl mit einer süßsauer Soße
schmecken würdest \ldots{}"
\end{center}
\begin{center}
...
\label{sec:orgdb5048d}
\begin{center}
\includegraphics[width=0.5\textwidth]{figures/umwelt.jpg}
\end{center} 
...
\end{center}
\begin{center}
"Erstens stimmt das nicht, \ldots{}", erwieder ich.
\end{center}
\begin{center}
"\ldots{}und zweitens na und?", vollendet er meinen Satz.
\end{center}
\begin{center}
...
nicht sagen \emph{Achtung, achtung, wir haben Schwierigkeiten den Fahrplan
...
\newpage
\section{Der Geist des Mathebau}
\label{sec:orgd0b63a6}
\begin{center}
\includegraphics[width=0.4\textwidth]{figures/geist.png}
\end{center}
...
mehr Pendelt, dann hört die Erde auf sich zu drehen \ldots{}", fahre ich fort.
\end{center}
...
manche munkeln, dem Eingang zur \ldots{} Unterwelt!!!"
\end{center}
...
paar Informatiker in das Gebäude lassen. Und \ldots{} der andere halt war
...
\begin{center}
"\ldots{}da waren's nur noch 4 \ldots{}.", mache ich eine Geisterstimme nach.
...
würde, also wand er sich an den Gehörnten\ldots{}"
\end{center}
\begin{center}
...
\begin{center}
"Maria, ehm \ldots{} LAUF!!!!!"
\end{center}
\newpage
\section{The Men in Beige}
\label{sec:org070662d}
\begin{center}
\includegraphics[width=0.3\textwidth]{figures/MIB2.jpg}
\end{center}
...
\end{center}
Ich blicke im Dreieck zu den drei Leuten hier. Zu den \emph{Agenten}, die
...
\end{center}
Zuschwer wirft mir einen \emph{Lass-Dass}-Blick zu. 
\begin{center}
...
auf der Couch, während die beiden MIB's in alter \emph{Uncle-Sam-wants-you}
...
\begin{center}
"\ldots{}und für mich eine Pizza Hawai\ldots{}"
\end{center}
...
\end{center}
\newpage
\section{Das Weihnachtsgeschenk}
\label{sec:org5e74105}
\begin{center}
\includegraphics[width=0.4\textwidth]{figures/present.jpg}
\end{center}

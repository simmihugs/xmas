...
\usepackage{listings}
\date{}
\title{Simon's Weihnachtsgeschichte 2023}
\hypersetup{
 pdfauthor={DESKTOP-EGBIMS8},
 pdftitle={Simon's Weihnachtsgeschichte 2023},
 pdfkeywords={},
 pdfsubject={},
 pdfcreator={Emacs 27.1 (Org mode 9.7-pre)}, 
 pdflang={English}}
\usepackage{biblatex}
\addbibresource{~/.config/emacs/bibliography/literature.bib}
\begin{document}
...
ging jedoch von uns. \newpage
\section{Am Bahnsteig nichts neues\ldots{}}
\label{sec:org1eb6cc8}
...
\begin{center}
\includegraphics[width=3cm]{fliegender-wecker.png}
\end{center}
...
\section{In 80 Zügen um die Welt}
\label{sec:org276f204}
...
\begin{center}
\includegraphics[width=3cm]{lok.png}
\end{center}
\section{Paris Stadt der Kellner}
\label{sec:orgf1d482b}
...
\begin{center}
\includegraphics[width=8cm]{paris.png}
\end{center}
...
etwas wie \emph{"Je voudrais acheter cinq timbres"} freuen. Soweit kommt
...
Wein stärken.
\section{Miniaturwelten}
\label{sec:org520cc7b}
...
\begin{center}
\includegraphics[width=8cm]{hamburg.png}
\end{center}
...
\section{Eskiomobier in München}
\label{sec:org41d7d8a}
...
trinken schmecken zu lassen. Ganz gemäß dem Motto \emph{7 Bier sind auch
...
\begin{center}
\includegraphics[width=4cm]{bier-deckel.png}
\end{center}

\noindent Seit ich ein Kind bin wundere ich mich, was hat denn
\emph{Monaco di Baviera} mit den Inuits zu tun? Bevor ich dieses
...
\section{\emph{Alpenüberquerung}}
\label{sec:orgff559ac}
...
\section{Intalien in der Sauna}
\label{sec:org4d826ff}
\begin{wrapfigure}{r}{0.4\textwidth} %this figure will be at the right
  \centering
...
\section{Lorenzo von Arabien}
\label{sec:orgf049193}
\begin{wrapfigure}{r}{0.4\textwidth} %this figure will be at the right
  \centering
...
am Horizont.
\section{Vom Regen in die Traufe}
\label{sec:orgef34ab0}
...
\begin{center}
\includegraphics[width=8cm]{in_the_whale.png}
\end{center}
\section{Auf den Spuren der Inka}
\label{sec:orgaaccf6a}
...
\begin{center}
\includegraphics[width=8cm]{peru.png}
\end{center}
\section{Das Dschunglebuch}
\label{sec:org26ff587}
...
ambitioniert. Stundenlang heißt es \emph{zu gleich, zu
...
\begin{center}
\includegraphics[width=8cm]{amazonas.png}
\end{center}
\section{Das Ende}
\label{sec:org18dac47}
